...
public:
    ...
    void update(xebble::World& world, float dt) override {
        ...
        switch (hi % 6) {
            case 0: spr.tint = {255, hi8,  0  }; break;
            case 1: spr.tint = {lo,  255,  0  }; break;
            case 2: spr.tint = {0,   255, hi8 }; break;
            case 3: spr.tint = {0,   lo,  255 }; break;
            case 4: spr.tint = {hi8, 0,   255 }; break;
            default:spr.tint = {255, 0,   lo  }; break;
        }
    }
    ...
    void draw(xebble::World& world, xebble::Renderer&) override {
        ...
        ui.panel("hud", {.anchor = xebble::Anchor::Bottom, .size = {1.0f, 34}},
            [&](auto& p) {
                p.text(u8"ex01 \u2014 Hello World  |  [Esc] Quit",
                       {.color = {220, 220, 220}});
