...
constexpr uint32_t MONSTERS[] = {
    SMALL_KOBOLD, KOBOLD,    LARGE_KOBOLD, CAVE_ORC,     SNAGA,       LARGE_SNAKE,
    FRUIT_BAT,    GIANT_RAT, WOLF,         FOREST_TROLL, WHITE_JELLY, FLOATING_EYE,
};
...
constexpr uint32_t ITEMS[] = {
    GOLD, GOLD, GOLD, SCROLL, POTION_RED, POTION_BLUE, POTION_GREEN, FOOD, TORCH, DAGGER,
};
constexpr const char* ITEM_NAMES[] = {
    "Gold",        "Gold",         "Gold",           "Scroll",       "Red Potion",
    "Blue Potion", "Green Potion", "Ration of Food", "Wooden Torch", "Dagger",
};
