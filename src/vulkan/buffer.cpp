...
std::expected<Buffer, Error> Buffer::create(VmaAllocator allocator, VkDeviceSize size,
    ...
    if (vmaCreateBuffer(allocator, &ci, &ai, &buf.impl_->buffer, &buf.impl_->allocation, nullptr) !=
        VK_SUCCESS) {
