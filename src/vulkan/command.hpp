...
[[nodiscard]] std::expected<VkCommandBuffer, Error> begin_one_shot(VkDevice device,
...
[[nodiscard]] std::expected<void, Error> end_one_shot(VkDevice device, VkCommandPool command_pool,
...
[[nodiscard]] std::expected<std::vector<VkCommandBuffer>, Error>
